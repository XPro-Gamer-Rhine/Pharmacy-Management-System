<?php
    ...
    $sku= $_GET["sku"];
    $image= $_GET["image"];
    $sql = "INSERT INTO datas(name,price,image,sku) VALUES ('".$name."','".$price."','".$image."','".$sku."')";
                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-quantity">SKU</th>
                                    ...
                                    ?>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href=""><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo $row['image']; ?>"></a>
                                            </td>
                                            ...
                                            <td class="product-price">
                                                <span class="amount"><?php echo $row['price']; ?> TK</span> 
                                            </td>

                                            <td class="product-price">
                                                <span class="amount"><?php echo $row['sku']; ?></span> 
                                            </td>

                                            <td class="product-subtotal">
                                            <span class="amount"><?php echo $row['price']; ?> BDT</span>  
                                            </td>
                                        </tr>
                                        <?php
                                            }     
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount"><?php echo $sum; ?> TK</span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount"><?php echo $sum; ?> BDT</span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
